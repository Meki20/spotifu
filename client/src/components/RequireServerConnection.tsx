  ...
  if (status === 'unreachable') {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[var(--bg-base)] p-6">
        <div className="bg-[var(--bg-surface)] p-8 rounded-lg w-full max-w-md space-y-4">
          <h1
          ...
          <p className="text-sm text-[var(--text-secondary)]" style={{ fontFamily: "'Barlow Semi Condensed', sans-serif" }}>
